...
class HomePage extends StatelessWidget {
  ...
  static const List<News> newsList = [
    News(
      ...
      content: 'Flutter 3.0 has many new things... (full story here)',
      category: 'Technology',
      date: 'Today',
    ),
    News(
      ...
      content: 'The team played really well... (full story here)',
      category: 'Sports',
      date: 'Yesterday',
    ),
    News(
      ...
      content: 'Many companies are growing... (full story here)',
      category: 'Business',
      date: '2 days ago',
    ),
    News(
      ...
      content: 'The phone has a great camera... (full story here)',
      category: 'Technology',
      date: '3 days ago',
    ),
  ];
